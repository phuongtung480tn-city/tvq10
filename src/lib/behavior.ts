...
export function buildVisitorBehaviorPayload(
  ...
  return {
    behavior: {
      ...behavior,
      session_phone_hint:
        phoneState.phoneHint || behavior.session_phone_hint || "",
      submitted_phone:
        phoneState.submittedPhone || behavior.submitted_phone || "",
    ...
    visitorBehaviorPayload: {
      ...
      sessionPhoneHint: phoneState.phoneHint || "",
      submittedPhone: phoneState.submittedPhone || "",
